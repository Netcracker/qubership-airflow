...
* For enabling TLS on airflow user interface, refer to the [Enabling TLS on airflow UI inside kubernetes](/docs/public/installation.md#enabling-tls-on-airflow-ui-inside-kubernetes) section in the _Airflow Service Installation Procedure_.
