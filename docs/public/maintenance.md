...
The connections and variables created through the UI (User Interface) or pod terminals must be updated through the UI or pod terminals. For more information, refer to the _Official Documentation_ at [https://airflow.apache.org/docs/apache-airflow/3.2.1/howto/connection.html](https://airflow.apache.org/docs/apache-airflow/3.2.1/howto/connection.html).
...
**Note**: It is possible to add a role during user creation. For more information, refer to the _Official Documentation_ at [https://airflow.apache.org/docs/apache-airflow-providers-fab/stable/cli-ref.html](https://airflow.apache.org/docs/apache-airflow-providers-fab/stable/cli-ref.html).
